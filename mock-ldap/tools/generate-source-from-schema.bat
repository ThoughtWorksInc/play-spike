...
rem Copyright 2008-2016 UnboundID Corp.
rem All Rights Reserved.
rem
rem -----
rem
rem Copyright (C) 2008-2016 UnboundID Corp.
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-se.jar;%CLASSPATH%" com.unboundid.ldap.sdk.persist.GenerateSourceFromSchema %*
