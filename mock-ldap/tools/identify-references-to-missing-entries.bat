...
rem -----
rem
rem Copyright (C) 2013-2016 UnboundID Corp.
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-se.jar;%CLASSPATH%" com.unboundid.ldap.sdk.examples.IdentifyReferencesToMissingEntries %*
