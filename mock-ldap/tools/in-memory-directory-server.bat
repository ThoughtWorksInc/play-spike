...
rem -----
rem
rem Copyright (C) 2011-2016 UnboundID Corp.
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk-se.jar;%CLASSPATH%" com.unboundid.ldap.listener.InMemoryDirectoryServerTool %*
